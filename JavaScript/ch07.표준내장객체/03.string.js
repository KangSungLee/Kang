...
// 메소드(method)
console.log(hello[1], hello.charAt(1));     // '녕' 어레이, 인덱스
console.log(hello + '여러분!', hello.concat('여러분!'));
console.log(hello.indexOf('하'));           // 2번째 글자
...
console.log(new Date().toLocaleString());   //2024. 1. 8. 오전 11:16:43
...
console.log(myDateTime());               //2024-01-08 11:24:25
...
// 정규 표현식 (딥 러닝을 이용한 자연어 처리 입문 > 02-05 정규 표현식 참조) https://wikidocs.net/book/2155 /https://wikidocs.net/21703
